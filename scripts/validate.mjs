...
const required = [
  ...
  'packages/provider-api-core/package.json','packages/provider-api-core/src/index.js','packages/provider-api-cli/package.json','packages/provider-api-cli/bin/provider-api.mjs',
